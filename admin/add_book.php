...
?>
        ...
        <div class="row">
                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <ul class="nav navbar-right panel_toolbox">
                            <li>
							<a href="scan/scan.php" style="background:none;">
							<button class="btn btn-primary"><i class="fa fa-qrcode"></i> Scan QR code</button>
							</a>
							</li>
                        </ul>
                        <div class="clearfix"></div>
                        ...
                        <!-- content starts here -->
							...
							<input type="hidden" name="new_barcode" value="<?php echo $new_barcode; ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="book_title" value="<?=isset($_GET['Title']) ? $_GET['Title']: '' ?>" id="first-name2" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" name="author" value="<?=isset($_GET['Author']) ? $_GET['Author']: '' ?>" id="first-name2" required="required" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" value="<?=isset($_GET['Publication']) ? $_GET['Publication']: '' ?>" name="book_pub" id="last-name2" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" value="<?=isset($_GET['Publisher']) ? $_GET['Publisher']: '' ?>" name="publisher_name" id="last-name2" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" value="<?=isset($_GET['Copyright']) ? $_GET['Copyright']: '' ?>" name="copyright_year" id="last-name2" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-1">
                                        <input type="number" value="<?=isset($_GET['Copies']) ? $_GET['Copies']: '' ?>" name="book_copies" step="1" min="0" max="1000" required="required"  class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
									...
									<div class="col-md-4">
                                        <select name="status" value="<?=isset($_GET['Status']) ? ucwords($_GET['Status']): '' ?>" class="select2_single form-control" tabindex="-1" required="required">
                                ...
                                <div class="form-group">
									...
									<div class="col-md-4">
                                        <select value="<?=isset($_GET['Category']) ? $_GET['Category']: '' ?>"  name="category_id" class="select2_single form-control" tabindex="-1" required="required">
										<?php
			...
			$error = $_FILES["image"] ["error"];
			{
                    ...
                    echo "<script>
                            window.location.href='view_barcode.php?code=".$gen."
                        </script>";
					}
                }
            }
