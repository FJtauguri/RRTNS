...
<body style="background-image: url(https://wallpaperboat.com/wp-content/uploads/2020/02/education-13.jpg);">
    
<body>
	<div class = "container">
		<div id = "header">
		<br/>
				<img src = "images/rrt.png" style = " margin-top:-17px; float:left; margin-left:115px; margin-bottom:-6px; width:100px; height:100px;">
				<img src = "images/OIP.jpg" style = " margin-top:-17px; float:right; margin-right:115px; width:100px; height:100px;" >
				...
				<center><h5 style = "font-style:Calibri; margin-top:-14px;"></h5> Rosauro R Tangson Sr National High School</center>
