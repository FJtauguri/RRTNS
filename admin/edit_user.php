  ...
  ?>
                        ...
                        <!---        <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <input type="password" value="<?php echo $row['password']; ?>" name="password" id="first-name2" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
...
{		
mysqli_query($con," UPDATE user SET school_number='$school_number', firstname='$firstname', middlename='$middlename', lastname='$lastname', contact='$contact', 
gender='$gender', address='$address', type='$type', level='$level', section='$section' , password = '$password' WHERE user_id = '$id' ")or die(mysqli_error());
