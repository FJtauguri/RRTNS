                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12" style="display: grid; align-items: center;">
                                    <form method="post" enctype=multipart/form-data class="w-100" style="">
                                        ...
                                        <!-- 
                                            ...
                                            FROM HERE, write a code just like this code below for my admin table and add an ajax function that if confirm_password is not equal to password, make the button inactive and grey and if it is good then make it blue and active. 
