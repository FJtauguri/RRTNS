            ...
            <div class="profile">
                ...
                <div class="profile_pic">
                    <?php if ($row['admin_image'] != ""): ?>
                        <img src="upload/<?php echo $row['admin_image']; ?>" style="height:65px; width:75px;"
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li><a href="user.php"><i class="fa fa-users"></i> Members</a></li>
                    <li><a href="book.php"><i class="fa fa-book"></i> Books</a></li>
                    <li><a href="admin.php"><i class="fa fa-user"></i> Admin</a></li>
                    <li><a href="user_log_in.php"><i class="fa fa-users"></i> Members Attendance</a></li>
                    <li><a href="backup-restore.php"><i class="fa fa-user"></i> Backup and Restore</a></li>
                </ul>
            </div>
            <div class="menu_section">
                ...
                <div class="separator"></div>
                <ul class="nav side-menu">
                    <li><a href="borrow.php"><i class="fa fa-edit"></i> Borrow</a></li>
                    ...
                    <li><a href="account_setting.php"><i class="fa fa-info"></i> Account Setting</a></li>
