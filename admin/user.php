				...
				<ul class="nav navbar-right panel_toolbox">
					...
					<li>
						<a href="import_members.php" style="background:none;">
							<button class="btn btn-success btn-outline"><i class="fa fa-upload"></i> Import
								Members</button>
						</a>
					</li>
					<li>
						<a href="recycle_bin_user.php" style="background:none;">
							<button class="btn btn-danger btn-outline"><i class="fa fa-trash"></i> Recycle Bin</button>
						</a>
					</li>
					<!---    <li>
				...
				<div class="table-responsive">
					<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered"
						...
						<tbody>
							...
							<?php
							$result = mysqli_query($con, "select * from user WHERE status2 =0 order by user_id DESC  ") or die(mysqli_error());
